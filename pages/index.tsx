    ...
    <div className="bg-neutral-900 min-h-screen flex flex-col items-center md:px-0 px-6">
      ...
      <div className="items-start md:mt-24 mt-8 transition-all duration-[100]">
        <header className="flex flex-col justify-start ">
          ...
          <p className="text-neutral-300 text-sm pt-6 md:max-w-[26rem]">When I’m not studying, I develop side projects that scratch the itch to build beautiful, performant things that solve problems.</p>
          <SocialIcons />
        </header>

        <main>
          <div className="md:relative mt-12 transition-all duration-[100]">
            <h2 className="text-neutral-50 text-sm md:absolute md:left-[-4rem] md:top-0 pb-2 font-medium">Now</h2>
          ...
          <div className="md:relative md:mt-16 mt-8 transition-all duration-[100]">
            <h2 className="text-neutral-50 text-sm md:absolute md:left-[-5.5rem] md:top-0 pb-7 font-medium">Projects</h2>
            <div className="flex flex-col">
              ...
              <h3 className="text-neutral-50 text-base md:pt-9 pt-7">Listening To</h3>
              ...
              <div className="flex md:flex-row flex-col justify-start pt-3 md:gap-14 gap-8">
                <div className="flex flex-col gap-4">
                  <p className="text-neutral-300 text-sm md:max-w-xs leading-5">Lets Last.fm users share a link with their friends that shows what music they’ve been listening to recently.</p>
                  <p className="text-neutral-300 text-sm md:max-w-xs leading-5">Built with Next.js + React + Last.fm API, deployed with Vercel.</p>
                </div>
                <div>
                  ...
                  <div className="flex md:flex-col flex-row align-middle md:gap-2 gap-3">
                    <a href="https://listening-to.vercel.app" className="text-neutral-100 text-xs md:pt-1 hover:text-blue-300 hover:cursor-pointer transition-all duration-[100]">Check it out -&gt;</a>
