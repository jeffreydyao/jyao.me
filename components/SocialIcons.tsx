...
export default function SocialIcons() {
  return (
    <div className="flex flex-row gap-4 pt-6 items-center">
      <a aria-label="GitHub" title="GitHub" href="https://github.com/jeffreydyao">
      ...
      <a aria-label="LinkedIn" title="LinkedIn - WIP"> {/* TODO: Update LinkedIn profile and add link */}
      ...
      <a aria-label="Twitter" title="Twitter - WIP"> {/* TODO: Update LinkedIn profile and add link */}
        <svg className="w-5 fill-neutral-50 hover:fill-blue-300 transition-all duration-[100]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15">
